...
public class StudentService
{
    ...
    public string GetFacultyWithHighestAverageGrade() => _students.GroupBy(s => s.Faculty).OrderByDescending(g => g.Average(s => s.Grades.Average())).Select(g => g.Key).FirstOrDefault() ?? string.Empty;
}